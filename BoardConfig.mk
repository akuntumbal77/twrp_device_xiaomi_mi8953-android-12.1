...
# Kernel - prebuilt (shared msm8953 platform kernel, no in-tree kernel source build)
# NOTE: verify this Image.gz-dtb (currently reused from device/xiaomi/vince) boots
# your actual target board; swap prebuilt/Image.gz-dtb if it does not.
...
# Partitions - dynamic (retrofit, not real dynamic A/B)
# Group name/sizes match android_device_xiaomi_vince-lineage-22 (mi8953 family)
...
# TWRP Configuration
TW_DEVICE_VERSION := msm8953 (mi8953) | RenzAlt
